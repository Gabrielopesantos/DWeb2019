        ...
        if (purl.pathname == '/') {
            jsonfile.readFile(myBD, (erro, tarefas) => {
                ...
                if (!erro) {
                    ...
                    res.write(pug.renderFile('erro.pug', { e: "Erro na leitura do ficheiro" }))
                }
                res.end()
            })
            ...
            res.write(pug.renderFile('erro.pug', { e: "Caminho inexistente" }))
            res.end()
        }
            ...
            recuperaInfo(req, resultado => {
                jsonfile.readFile(myBD, (erro, tarefa) => {
                    if (!erro) {
                        ...
                        jsonfile.writeFile(myBD, tarefa, erro => {
                            if (erro)
                                console.log(erro)
                            else
